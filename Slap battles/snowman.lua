local SimpleGui = loadstring(game:HttpGet("https://pastefy.app/pT3jEHFx/raw?c="..time()))()

local guiTable = {}
guiTable.window = SimpleGui:CreateWindow({Name = "snowman"})

guiTable.window:CreateButton({
    Name = "Speedy Sam quest",
    Callback = function()
